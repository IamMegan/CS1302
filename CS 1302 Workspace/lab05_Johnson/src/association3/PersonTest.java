...
public class PersonTest {
	...
	// Add 4 dogs and then remove from index=1
	public static void testRemoveDog_From_Middle_4_Dogs() {
		...
		p.addDog(new Dog("Leo"));
		p.addDog(new Dog("Fritzy"));
		p.addDog(new Dog("Fiddo"));
		
		System.out.println("Num dogs before remove_Dog_From_Middle_4_Dogs:" + p.getNumDogs());
		
		
		Dog d = p.removeDog(1);
		
		System.out.println("Num dogs after remove_Dog_From_Middle_4_Dogs:" + p.getNumDogs());
		System.out.println("Dog Removed:" + d);
		
	}

	// Add 4 dogs and then remove from index=3
	public static void testRemoveDog_From_End_4_Dogs() {
		...
		System.out.println("Num dogs before remove_Dog_From_End_4_Dogs:" + p.getNumDogs());
		
		
		Dog d = p.removeDog(3);
		
		System.out.println("Num dogs after remove_Dog_From_End_4_Dogs:" + p.getNumDogs());
		System.out.println("Dog Removed:" + d);
		
	}

	// Add 4 dogs and then remove from index=0
	public static void testRemoveDog_From_Beginning_4_Dogs() {
		...
		System.out.println("Num dogs before remove_Dog_From_Beginning_4_Dogs:" + p.getNumDogs());
		
		
		Dog d = p.removeDog(0);
		
		System.out.println("Num dogs after remove_Dog_From_Begining_4_Dogs:" + p.getNumDogs());
		System.out.println("Dog Removed:" + d);
